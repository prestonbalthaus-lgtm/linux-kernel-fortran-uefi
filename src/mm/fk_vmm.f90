...
module fk_vmm_m
  ...
  ! Roadmap 5.1.  The xHCI's BAR0 register block, which carries the MSI-X
  ! table as well as the controller's own registers.  Strong-UC like every
  ! other aperture here: the table is a device register file, and a write-back
